...
option = {
  ...
  1129: "Dhamangaon Education Society's College of Engineering and Technology, Dhamangaon",
  ...
  2128: "Maharashtra College of Engineering, Nilanga",
  ...
  2132: "M.G.M.'s Jawaharlal Nehru Engineering College, Aurangabad",
  ...
  3174: "Ramrao Adik Edu Soc, Ramarao Adik Institute of Tech., Navi Mumbai",
  ...
  4178: "Rajiv Gandhi College of Engineering & Research, Hingna Road, Nagpur",
  ...
  4186: "Datta Meghe Institute of Medical Science's Datta Meghe Institute of Engineering & Technology & Research, Savangi (Meghe)",
  ...
  4305: "G.H.Raisoni Academy of Engineering & Technology, Nagpur",
  ...
  5176: "G. H. Raisoni College of Engineering and Management, Ahmednagar",
  ...
  6323: "D. Y. Patil College of Engineering, Ambi, Talegaon, Maval",
  ...
  6620: "D. Y. Patil Institute of Engineering and Technology, Ambi",
  ...
  6787: "Dr. D. Y. Patil Educational Academy's, D.Y.Patil School of Engineering Academy, Ambi",
...
searchBox.oninput = function () {
  ...
  for (var name in option) {
    collegeName = option[name].toLowerCase();
    if (collegeName.includes(searchBox.value.toLowerCase())) {
      suggestionContainer.appendChild(createItem(name));
    }
  }
};
...
function createItem(name) {
  ...
  item.setAttribute(
    "class",
    "collegeList-item border-2 bg-gray-900 text-white px-5 py-3 border-gray-700"
  );
  //   item.setAttribute("id");
  item.append(option[name]);
  item.onclick = () => {
    searchBox.value = option[name];
